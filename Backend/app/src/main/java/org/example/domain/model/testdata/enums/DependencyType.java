...
public enum DependencyType {
    ...
    /**
     * Пропускная зависимость - данные проходят через без изменений
     */
    PASS_THROUGH("pass_through"),

    /**
     * Генерируемая зависимость - данные генерируются автоматически
     */
    GENERATED("generated"),

    /**
     * Извлекаемая зависимость - данные извлекаются из внешних источников
     */
    FETCHED("fetched"),

    /**
     * Входная зависимость - данные предоставляются извне
     */
    INPUT("input"),

    /**
     * Определяемая зависимость - данные определяются на основе других данных
     */
    DETERMINED("determined"),

    /**
     * Проверенная зависимость - данные проверены и верифицированы
     */
    VERIFIED("verified");
