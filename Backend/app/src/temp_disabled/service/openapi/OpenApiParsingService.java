...
public class OpenApiParsingService {
    ...
    @Autowired
    public OpenApiParsingService(OpenApiServiceRepository serviceRepository, 
    ...
    private OpenApiParsingResult parseSpecification(String specContent, String sourceUrl, OpenApiFormat format) {
        try {
            ...
            // Извлечение схем
            List<ApiSchema> schemas = extractSchemas(specNode, metadata.getVersion());
    ...
    private OpenApiMetadata extractMetadata(JsonNode specNode) {
        ...
        if (openapiNode != null) {
            ...
            metadata.setVersion(OpenApiVersion.V3_0_0); // Упрощенно
        } else if (swaggerNode != null) {
            String version = swaggerNode.asText();
            metadata.setVersion(OpenApiVersion.V2_0);
        }
    ...
    private OpenApiService createService(OpenApiMetadata metadata, String sourceUrl) {
        ...
        service.setOpenApiVersion(metadata.getVersion());
    ...
    public static class OpenApiMetadata {
        ...
        public OpenApiVersion getVersion() { return openApiVersion; }
        public void setVersion(OpenApiVersion openApiVersion) { this.openApiVersion = openApiVersion; }
    }
